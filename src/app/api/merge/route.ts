...
본문...`;
    ...
    prompt = `기존 위키에 새 자료를 통합하여 업데이트하세요.
...
세 번째 줄부터: 업데이트된 마크다운 위키 본문

━━━ 통합 규칙 ━━━
1. **마지막 업데이트**: ${today} | **자료 수**: ${allLinkedNoteCount}개 로 갱신
2. ## 목차 섹션을 최상단에 유지하고, 새 섹션 추가 시 목차에도 링크 추가
3. 모든 ## 헤딩의 {#앵커id} 유지 및 새 섹션엔 앵커 추가
4. 관련 섹션 간 상호 링크 유지/추가
5. 새 자료 내용을 관련 섹션에 항목으로 추가, 새 주제면 새 섹션 생성
6. 기존 내용 삭제 금지
